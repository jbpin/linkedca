...
const (
	...
	Provisioner_EST    Provisioner_Type = 12
)
...
const (
	...
	ACMEProvisioner_ANDROIDKEY ACMEProvisioner_AttestationFormatType = 4
)
...
func (Webhook_Kind) EnumDescriptor() ([]byte, []int) {
	return file_linkedca_provisioners_proto_rawDescGZIP(), []int{24, 0}
}
...
func (Webhook_CertType) EnumDescriptor() ([]byte, []int) {
	return file_linkedca_provisioners_proto_rawDescGZIP(), []int{24, 1}
}
...
func (x *ProvisionerDetails) GetEST() *ESTProvisioner {
	if x != nil {
		if x, ok := x.Data.(*ProvisionerDetails_EST); ok {
			return x.EST
		}
	}
	return nil
...
type ProvisionerDetails_EST struct {
	EST *ESTProvisioner `protobuf:"bytes,31,opt,name=EST,proto3,oneof"`
}
...
func (*ProvisionerDetails_EST) isProvisionerDetails_Data() {}
...
type ACMEProvisioner struct {
	...
	RevokedCertificateSerials []string                                `protobuf:"bytes,9,rep,name=revoked_certificate_serials,json=revokedCertificateSerials,proto3" json:"revoked_certificate_serials,omitempty"`
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}
...
func (x *ACMEProvisioner) GetRevokedCertificateSerials() []string {
	if x != nil {
...
func (x *ESTProvisioner) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ESTProvisioner) ProtoMessage() {}

func (x *ESTProvisioner) ProtoReflect() protoreflect.Message {
	mi := &file_linkedca_provisioners_proto_msgTypes[20]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ESTProvisioner.ProtoReflect.Descriptor instead.
func (*ESTProvisioner) Descriptor() ([]byte, []int) {
	return file_linkedca_provisioners_proto_rawDescGZIP(), []int{20}
}

func (x *ESTProvisioner) GetForceCn() bool {
	if x != nil {
		return x.ForceCn
	}
	return false
...
func (x *ESTProvisioner) GetEnableTlsClientCertificate() bool {
	if x != nil {
		return x.EnableTlsClientCertificate
	}
	return false
}

func (x *ESTProvisioner) GetEnableHttpBasicAuth() bool {
	if x != nil {
		return x.EnableHttpBasicAuth
	}
	return false
}

func (x *ESTProvisioner) GetMinimumPublicKeyLength() int32 {
	if x != nil {
		return x.MinimumPublicKeyLength
	}
	return 0
...
func (x *ESTProvisioner) GetIncludeRoot() bool {
	if x != nil {
		return x.IncludeRoot
	}
	return false
...
func (x *ESTProvisioner) GetBasicAuthUsername() string {
	if x != nil {
...
func (x *ESTProvisioner) GetBasicAuthPassword() string {
	if x != nil {
...
func (x *ESTProvisioner) GetClientCertificateRoots() [][]byte {
	if x != nil {
...
func (x *Webhook) Reset() {
	*x = Webhook{}
	mi := &file_linkedca_provisioners_proto_msgTypes[24]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Webhook) Descriptor() ([]byte, []int) {
	return file_linkedca_provisioners_proto_rawDescGZIP(), []int{24}
}
...
const file_linkedca_provisioners_proto_rawDesc = "" +
	"\n" +
	"\x1blinkedca/provisioners.proto\x12\blinkedca\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x15linkedca/policy.proto\"\xb1\x05\n" +
	...
	"\bwebhooks\x18\f \x03(\v2\x11.linkedca.WebhookR\bwebhooks\"\x89\x01\n" +
	"\x04Type\x12\b\n" +
	...
	"\x06Nebula\x18\x1e \x01(\v2\x1b.linkedca.NebulaProvisionerH\x00R\x06Nebula\x12,\n" +
	"\x03EST\x18\x1f \x01(\v2\x18.linkedca.ESTProvisionerH\x00R\x03ESTB\x06\n" +
	"\x04data\"L\n" +
	...
	"\n" +
	"object_ids\x18\a \x03(\tR\tobjectIds\"\xff\x04\n" +
	...
	"\x0ecaa_identities\x18\b \x03(\tR\rcaaIdentities\x12>\n" +
	"\x1brevoked_certificate_serials\x18\t \x03(\tR\x19revokedCertificateSerials\"\\\n" +
	...
	"\x16enable_http_basic_auth\x18\x03 \x01(\bR\x13enableHttpBasicAuth\x129\n" +
	"\x19minimum_public_key_length\x18\x04 \x01(\x05R\x16minimumPublicKeyLength\x12!\n" +
...
var file_linkedca_provisioners_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
var file_linkedca_provisioners_proto_goTypes = []any{
	...
	(*ESTProvisioner)(nil),                     // 25: linkedca.ESTProvisioner
	(*NebulaProvisioner)(nil),                  // 26: linkedca.NebulaProvisioner
	(*BasicAuth)(nil),                          // 27: linkedca.BasicAuth
	(*BearerToken)(nil),                        // 28: linkedca.BearerToken
	(*Webhook)(nil),                            // 29: linkedca.Webhook
	(*timestamppb.Timestamp)(nil),              // 30: google.protobuf.Timestamp
	(*Policy)(nil),                             // 31: linkedca.Policy
}
var file_linkedca_provisioners_proto_depIdxs = []int32{
	...
	30, // 5: linkedca.Provisioner.created_at:type_name -> google.protobuf.Timestamp
	30, // 6: linkedca.Provisioner.deleted_at:type_name -> google.protobuf.Timestamp
	31, // 7: linkedca.Provisioner.policy:type_name -> linkedca.Policy
	29, // 8: linkedca.Provisioner.webhooks:type_name -> linkedca.Webhook
	...
	26, // 20: linkedca.ProvisionerDetails.Nebula:type_name -> linkedca.NebulaProvisioner
	25, // 21: linkedca.ProvisionerDetails.EST:type_name -> linkedca.ESTProvisioner
	5,  // 22: linkedca.ProvisionerList.provisioners:type_name -> linkedca.Provisioner
	10, // 23: linkedca.Claims.x509:type_name -> linkedca.X509Claims
	11, // 24: linkedca.Claims.ssh:type_name -> linkedca.SSHClaims
	12, // 25: linkedca.X509Claims.durations:type_name -> linkedca.Durations
	12, // 26: linkedca.SSHClaims.user_durations:type_name -> linkedca.Durations
	12, // 27: linkedca.SSHClaims.host_durations:type_name -> linkedca.Durations
	1,  // 28: linkedca.ACMEProvisioner.challenges:type_name -> linkedca.ACMEProvisioner.ChallengeType
	2,  // 29: linkedca.ACMEProvisioner.attestation_formats:type_name -> linkedca.ACMEProvisioner.AttestationFormatType
	...
	28, // 32: linkedca.Webhook.bearer_token:type_name -> linkedca.BearerToken
	27, // 33: linkedca.Webhook.basic_auth:type_name -> linkedca.BasicAuth
...
func file_linkedca_provisioners_proto_init() {
	...
	file_linkedca_provisioners_proto_msgTypes[2].OneofWrappers = []any{
		...
		(*ProvisionerDetails_EST)(nil),
	}
	file_linkedca_provisioners_proto_msgTypes[11].OneofWrappers = []any{}
	file_linkedca_provisioners_proto_msgTypes[24].OneofWrappers = []any{
